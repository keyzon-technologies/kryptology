...
```$xslt
go get github.com/keyzon-technologies/kryptology@v1.6.0
```

## Documentation

Public documentations can be found at https://pkg.go.dev/github.com/keyzon-technologies/kryptology

To access the documentation of the local version, run `godoc -http=:6060` and open
the following url in your browser.

http://localhost:6060/pkg/github.com/keyzon-technologies/kryptology/
...
- Threshold ECDSA Signature
  ...
  - [DKLS19 - DKG, Signing and Key Refresh](pkg/tecdsa/dkls/v2)
